...
Project managenet >> Planning >> 'Material Indent Qnty' Screen. 
...
public class erp05_Planning_Material_Indent_Qnty
{
	...
	int WO_number = 1;
	String inputSheetName = "MatIndentQnty";
	// ****************************************************************************
	...
	public void LOAwork() throws InterruptedException 
	{
		...
		driver.get("http://prosoft-dev.gyanfinder.com/planning/materialIndent/index/workorder_id/"+ WO_number);
		
		driver.findElement(By.xpath(".//*[@id='planning-mi-grid']/table/tbody/tr[1]/td[3]/a[1]/span")).click();
