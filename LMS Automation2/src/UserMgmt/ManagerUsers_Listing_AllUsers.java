...
public class ManagerUsers_Listing_AllUsers {
	public static WebDriver driver;
	public static Selenium selenium;
	//public String baseUrl;
	GlobalDecl GV = new GlobalDecl();
	//String Role = "2"; //Student;
	int a,b,pages;
	...
	@Test
	public void managerUsers_Listing_AllUsers() throws InterruptedException, RowsExceededException, WriteException, BiffException, IOException {
