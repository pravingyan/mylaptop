...
public class FacebookMobiles {
...

	{
		...
		String Username = JOptionPane.showInputDialog("Pls enter your 'Username'");

		driver.findElement(By.xpath("//input[@id='email']")).sendKeys(Username);

		String Password = JOptionPane.showInputDialog("Pls enter your 'Password'");
...

	{
		...
		for (int i =0 ; i < s.getRows(); i++)
		{
			...
			try 
			{
				...
				phone = driver.findElement(By.xpath(".//*[@id='pagelet_contact']/div/div/div/div/div")).isDisplayed();
			...
			if (aa == 1)
			{
				String cell = driver.findElement(By.xpath(".//*[@id='pagelet_contact']/div/div")).getText();
