...
public class NewTest1 extends TestBase{
	...
	public void f() throws InterruptedException {
		...
		System.out.println("User 1 Logged in");
		for (int a = 0; a < 10; a++) {
			...
			getDriver().findElement(By.xpath(".//*[@id='title']")).sendKeys("AutomationONE");
			...
			//	System.out.println("AutomationONE Created......");
			Thread.sleep(3000);
			//Click on 'Course Administartion'.
			getDriver().findElement(By.xpath(".//*[@id='acc3']/li[4]/a")).click();
			...
			for (int i = 2; i < tr1.size(); i++) {
				...
				if (s.contains("AutomationONE")) 
				{
					//Delete the Course.
					getDriver().findElement(By.xpath(".//*[@id='view-content']/div/div/table/tbody/tr[" +i+ "]/td[4]/a[2]")).click();
					//System.out.println("AutomationONE Course Deleted......");
					break;
				}
			}
		}

		System.out.println("User 1 closed...");
	}
