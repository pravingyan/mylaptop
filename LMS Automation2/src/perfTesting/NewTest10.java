...
public class NewTest10 extends TestBase{
	...
	public void f() throws InterruptedException {
		...
		getDriver().findElement(By.id("email")).sendKeys("dheeruk1947@gmail.com");
		getDriver().findElement(By.id("password")).sendKeys("Prison123456");

		getDriver().findElement(By.id("submit")).click();
		Thread.sleep(2000);

		System.out.println("User 10 Logged in");
		for (int z = 0; z < 10; z++) {
		...
		System.out.println("User 10 Closed");
	}
