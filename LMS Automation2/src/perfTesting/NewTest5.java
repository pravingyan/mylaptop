...
public class NewTest5 extends TestBase{
	...
	public void f() throws InterruptedException {
		...
		getDriver().findElement(By.id("email")).sendKeys("shraavankumar2227@gmail.com");
		getDriver().findElement(By.id("password")).sendKeys("Prison123456");

		getDriver().findElement(By.id("submit")).click();
		Thread.sleep(2000);

		System.out.println("User 5 Logged in");
		...
		System.out.println("User 5 Closed");
	}
