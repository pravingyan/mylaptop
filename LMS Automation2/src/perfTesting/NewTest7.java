...
public class NewTest7 extends TestBase{
	...
	public void f() throws InterruptedException {
		...
		getDriver().findElement(By.id("email")).sendKeys("raghuu1947@gmail.com");
		...
		System.out.println("User 7 Logged in");
		...
		System.out.println("User 7 Closed");
	}
