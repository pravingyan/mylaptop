...
public class NewTest8 extends TestBase{
	...
	public void f() throws InterruptedException {
		...
		getDriver().findElement(By.id("email")).sendKeys("ramesher1947@gmail.com");
		getDriver().findElement(By.id("password")).sendKeys("Prison123456");

		getDriver().findElement(By.id("submit")).click();
		Thread.sleep(2000);

		System.out.println("User 8 Logged in");
		...
		System.out.println("User 8 Closed");
	}
