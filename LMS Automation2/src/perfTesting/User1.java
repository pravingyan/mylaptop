...
public class User1
{
	...
	@Test
	public void User1() throws InterruptedException, RowsExceededException, WriteException, BiffException, IOException {
		...
		driver.findElement(By.id("email")).sendKeys("praveenkd@gyanwebsolutions.com");
		driver.findElement(By.id("password")).sendKeys("Kumar7may");
